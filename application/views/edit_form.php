                  ...
                  <div class="row g-5 g-xxl-10">
                    ...
                    <div class="col-xl-12 col-xxl-12 mb-5 mb-xxl-12">
                      ...
                      <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px h-xl-100 border-0 bg-gray-200" style="background-position: 100% 100%;background-size: 500px auto;background-image:url('/good/assets/media/misc/city.png')">
                        <!--begin::Body-->
                         <h3 class="text-center my-2">Update User</h3>
                      <hr>
                            <?php 
                      ...
                      <form method="post" action="<?php echo  base_url(); ?>/welcome/update_user">
                        <div class="card-body d-flex flex-column justify-content-center ps-lg-15">
                          ...
                          <div class="form-row">
                           ...
                           <div class="form-row">
                            ...
                            <input type="text" name="user_company" class="form-control" id="user_company"value="<?php echo $result->company_name; ?>">
                          ...
                          <div class="form-row">
                            ...
                            <select class="form-control form-select" name="emp_type" id="emp_type" aria-label="Default select example" placeholder="" value="">                                                          
