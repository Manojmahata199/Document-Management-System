                    ...
                    <div class="col-xl-12 col-xxl-12 mb-5 mb-xxl-12">
                      ...
                      <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px h-xl-100 border-0 bg-gray-200" style="background-position: 100% 100%;background-size: 500px auto;background-image:url('/good/assets/media/misc/city.png')">
                        ...
                        <div class="d-flex row col-md-12 my-2">
                            <a href=""></a><h3 class="text-center my-2 col-md-10">All Link List</h3></a>
                             <a href="<?php echo base_url('welcome/link_list'); ?>" class="btn btn-info col-md-1 text-center text-white"><i class="fa fa-rotate"></i> Refresh</a>
                            <a href="<?php echo base_url('welcome/upload_link_view'); ?>" class="btn btn-success col-md-1 text-center text-white"><i class="fa fa-folder-plus"></i> Create</a>

                             <form action="<?php echo base_url(); ?>welcome/search_link_list" method="post">
                             ...
                             $emp_type=$this->session->userdata('emp_type');
                                   ...
                                   if($emp_type=="admin"){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('welcome/link_view/'.$d->id.''); ?>" style="height:50px; width:50px;"><i class="fa fa-file"></i> <?php echo $d->link_title; ?></td></a>

                                            <td><?php echo $d->link_title; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-secondary" href="<?php echo base_url('welcome/download_link/'.$d->id.''); ?>"><i class="fa fa-download"></i></a>
                                               <!-- <a  href=""><i class="fa fa-download"></i></a> -->
                                               <!-- <a class="btn btn-info" href=""><i class="fa-solid fa-pen-to-square"></i></a> -->
                                               <a class="btn btn-info" href="<?php echo $d->link; ?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>

                            <?php   }else{

                                              if($d->link_upload_by_id==$login_id){  ?>
                                                   <tr>
