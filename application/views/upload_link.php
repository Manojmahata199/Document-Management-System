                  ...
                  <div class="row g-5 g-xxl-10">
                    ...
                    <div class="col-xl-12 col-xxl-12 mb-5 mb-xxl-12">
                      ...
                      <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px h-xl-100 border-0 bg-gray-200" style="background-position: 100% 100%;background-size: 500px auto;background-image:url('/good/assets/media/misc/city.png')">
                        <!--begin::Body-->
                         <h3 class="text-center my-2">Create New Document With Link</h3>
                      <hr>
                      <?php 
					 ...
					 <form  method="post" action="<?php echo base_url(); ?>welcome/upload_link_operation" enctype="multipart/form-data" class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate" id="kt_modal_create_campaign_stepper_form">
							                <!--begin::Step 1-->
							                   ...
							                   <!--  <div class="pb-10 pb-lg-15">
							                    ...
							                    <div class="mb-4 fv-row">
							                     ...
							                     <div class="mb-10 fv-row">
							                      <!--begin::Label-->
							                      <label class="required form-label mb-2">Upload Link</label>
							                      <!--end::Label-->
							                      <!--begin::Input-->
							                      <input type="text" class="form-control form-control-lg form-control-solid" name="doc_link" id="doc_link" placeholder="" value="">
							                      <span class="text-danger"><?php echo form_error("doc_link"); ?></span> 
							                      <!--end::Input-->
							                    </div>
							                     <div class="mb-10 fv-row">
							                      <!--begin::Label-->
